...
#物流跟踪和退款页面
check_str_list = ["实物拍摄","商品头图","下单过程中出现异常","订单详情页面","支付页面","评论区截图页面","物流列表页面","物流跟踪页面","物流异常页面","退款页面","退货页面","换货页面","购物车页面","店铺页面","活动页面","优惠券领取页面","账户页面","投诉举报页面","平台介入页面","外部APP截图","其他类别图片"]
#check_str_list = ["实物拍摄","下单过程中出现异常","物流列表页面","物流跟踪页面","物流异常页面","退款页面","退货页面","换货页面","购物车页面","店铺页面","活动页面","优惠券领取页面","账户页面","投诉举报页面","平台介入页面","外部APP截图","其他类别图片"]
